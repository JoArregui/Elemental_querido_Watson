...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'es': {
      ...
      'successRate': 'Tasa acierto',
      'avgTime': 'Tiempo medio',
      'totalTime': 'Tiempo total',
      'avgHints': 'Pistas medias',
      'sessions': 'Sesiones',
      'mostPlayedBook': 'Libro más jugado',
      'branchedStories': 'historias ramificadas',
      'perBookBreakdown': 'Desglose por libro',
      'telemetry': 'Telemetría',
      'telemetryNote': 'Datos guardados localmente (SharedPreferences). Sin envío a red.',
      // puzzle card
      ...
      'blueStarEarned': '¡Estrella azul conseguida!',
      'blueStarHint': 'El Acertijo Final no da experiencia: otorga una estrella azul ★',
      'blueStarLocked': 'Resuelve el Acertijo Final para ganar la estrella azul ★',
      'readingMode': 'Modo de juego',
      'modeSimple': 'Modo simple',
      'modeSimpleDesc': 'Puedes pasar de página sin resolver el acertijo',
      'modeStrict': 'Modo exigente',
      'modeStrictDesc': 'Hay que acertar el acertijo para pasar de página',
      'strictLocked': 'Resuelve el acertijo para pasar de página',
      'locked': 'Bloqueado',
    },
    'en': {
      ...
      'avgHints': 'Avg hints',
      'sessions': 'Sessions',
      'mostPlayedBook': 'Most played book',
      'branchedStories': 'branched stories',
      'perBookBreakdown': 'Per-book breakdown',
      'collectibles': 'Collectibles',
      'secrets': 'Secrets',
      'rewards': 'Rewards',
      'telemetry': 'Telemetry',
      'telemetryNote': 'Data stored locally (SharedPreferences). No network upload.',
      ...
      'viewEnd': 'View ending',
      'blueStar': 'Blue star',
      'blueStarEarned': 'Blue star earned!',
      'blueStarHint': 'The Final Riddle gives no XP: it awards a blue star ★',
      'blueStarLocked': 'Solve the Final Riddle to earn the blue star ★',
      'readingMode': 'Game mode',
      'modeSimple': 'Easy mode',
      'modeSimpleDesc': 'You can turn pages without solving the puzzle',
      'modeStrict': 'Strict mode',
      'modeStrictDesc': 'You must solve the puzzle to turn the page',
      'strictLocked': 'Solve the puzzle to turn the page',
      'locked': 'Locked',
    },
  };
